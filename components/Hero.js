            ...
            <div className="container px-6 py-8 mx-auto">
                <div className="items-center lg:flex">
                    <div className="lg:w-1/2">
                        <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Full-Stack</h2>
                        ...
                        <div className="flex items-center mt-6 -mx-2">
                            ...
                            <a className="mx-2" target='_blank' rel='noopener noreferrer' href="https://www.linkedin.com/in/joshua-farin-2a35aa19a/" aria-label="Linkden">
                            ...
                            <a className="mx-2" target='_blank' rel='noopener noreferrer' href="https://github.com/Joshua-Farin" aria-label="Github">
                                <svg className="w-5 h-5 text-gray-700 fill-current dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div className="mt-8 lg:mt-0 lg:w-1/2">
                        <div className="flex items-center justify-center lg:justify-end">
                            <div className="max-w-lg">
                                <img className="object-cover object-center w-full h-64 rounded-md shadow" src="cat.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
